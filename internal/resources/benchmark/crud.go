...
func (r *BenchmarkResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	bench, err := r.client.GetBenchmarkByID(ctx, state.ID.ValueString())
	if err != nil {
...
func CreateBenchmarkResource(ctx context.Context, c *client.Client, req *client.BenchmarkRequestV2) (*client.BenchmarkResponseV2, error) {
	return c.CreateBenchmark(ctx, req)
}
